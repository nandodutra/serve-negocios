	...
	<?php else : ?>
		<!-- <div class="news-box">
			<?php foreach ($this->items as $i => $article) : ?>
				<div class="news-item d-flex">
					<div class="image-preview" style="background-image: url('<?php echo json_decode($article->images)->image_intro; ?>');"></div>
					<div class="text">
						<h2><?php echo $this->escape($article->title); ?></h2>
						<p><?php echo strip_tags($article->introtext); ?></p>

						<a class="btn btn-primary" href="<?php echo Route::_(RouteHelper::getArticleRoute($article->slug, $article->catid, $article->language)); ?>">
							Leia mais...
						</a>
					</div>
				</div>
		...
		<div class="card mb-3">
			<div class="row g-0 row-cols-12">
				<div class="col-md-4">
					<img src="<?php echo json_decode($article->images)->image_intro; ?>" class="img-fluid rounded-start" alt="...">
				</div>
				<div class="col-md-6">
					<div class="card-body">
						<h5 class="card-title"><?php echo $this->escape($article->title); ?></h5>
						<p class="card-text"><?php echo strip_tags($article->introtext); ?></p>
						<p class="card-text"><small class="text-muted">
							<a class="btn btn-link" href="<?php echo Route::_(RouteHelper::getArticleRoute($article->slug, $article->catid, $article->language)); ?>">
								Leia mais...
							</a>
						</small></p>
					</div>
