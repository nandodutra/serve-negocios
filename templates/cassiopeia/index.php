...
?>">
	...
	<div class="cover-image <?php echo $menu->route != 'home' ? ' inside' : 'home'; ?>" class="container-fluid">
		<div class="container d-flex align-items-center">
			<?php /**  if ($menu->route === 'home'): ?>
			<div>
				<h1>Somos especializados em:</h1>
				<ul>
					<li>Prestadores de serviços</li>
					<li>Comércio de produtos agropecuários</li>
					<li>Mercados e supermercados</li>
					<li>Distribuidora de bebidas</li>
					<li>Distribuidora de gás</li>
					<li>Petshop</li>
				</ul>
			</div>
			<?php  endif; */  ?>
