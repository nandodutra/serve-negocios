...
class JConfig {
	...
	public $dbsslca = '';
	public $dbsslcipher = '';
	public $secret = '4hUy3UTYRfqnJTxaL5BXrR55JrLsEBvl';
	public $gzip = false;
	public $error_reporting = 'default';
	public $helpurl = 'https://help.joomla.org/proxy?keyref=Help{major}{minor}:{keyref}&lang={langcode}';
	public $tmp_path = '/opt/bitnami/joomla/tmp';
	public $log_path = '/opt/bitnami/joomla/logs';
	public $live_site = '';
	public $force_ssl = 0;
	public $offset = 'America/Bahia';
	public $lifetime = 15;
